 ...
 <body class="l">
    ...
    <div>
        ...
        <center>
          ...
          <a href="{{route('ordenar_2','nombre')}}"><button type="button" class="btn btn-secondary">A-Z</button></a>

          <a href="{{route('ordenar_2','nombre2')}}"><button type="button" class="btn btn-secondary">Z-A</button></a>
      </center>
    </div>
    @endsection
